...
class ospi_tasks_midnight(cron_entry):
    ...
    def __init__(self, ospi_db, prune_log, compute_daily_adjustment, os_compute_daily_adjustment):
        ...
        self.os_compute_daily_adjustment = os_compute_daily_adjustment
    ...
    def run_tasks(self):
        ...
        self.os_compute_daily_adjustment()
